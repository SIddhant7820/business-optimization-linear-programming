# Business Optimization with Linear Programming - Quick Start Guide

## Overview
This notebook demonstrates solving a **production planning optimization problem** using Linear Programming (LP) and Python's PuLP library.
